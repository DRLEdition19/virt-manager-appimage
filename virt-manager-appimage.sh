...
./.local/share/junest/bin/junest -- yay --noconfirm -S gnu-free-fonts qemu-desktop libvirt edk2-ovmf dnsmasq iptables-nft $(echo "$BASICSTUFF $COMPILERS $DEPENDENCES $APP")
